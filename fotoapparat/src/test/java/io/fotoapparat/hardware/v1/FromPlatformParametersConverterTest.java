...
public class FromPlatformParametersConverterTest {
    ...
    @Mock
    Camera.Parameters platformParameters;
    ...
    public void pictureSize() throws Exception {
        ...
        // Then
        Size value = (Size)parameters.getValue(Parameters.Type.PICTURE_SIZE);
    ...
    public void previewSize() throws Exception {
        ...
        // Then
        Size value = (Size)parameters.getValue(Parameters.Type.PREVIEW_SIZE);
